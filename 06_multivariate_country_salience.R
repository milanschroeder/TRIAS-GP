...
ggsave("./output/descriptive_plots/new/ConcentrationOfCountryMentions_OverTime.png", pl.con, height = 10, width = 25, units = "cm")
...
ggsave("./output/descriptive_plots/new/ConcentrationOfCountryMentions_OverTime_noRU.png", pl.con, height = 10, width = 25, units = "cm")
...
ggsave("./output/descriptive_plots/new/CrudeSalienceModelFullPeriod.png", pl.salience.full, height = 10, width = 25, units = "cm")
...
ggsave("./output/descriptive_plots/new/CrudeSalienceModelnoRUUAPeriod.png", pl.salience.noWar, height = 10, width = 25, units = "cm")
...
ggsave("./output/multivariate_plots/SalienceModelFullPeriod_noRUUA.png", height = 10, width = 25, units = "cm")
...
ggsave("./output/multivariate_plots/CountrySalience_Explained_noRUUA.png", pl.comb, 
       width = 16, height = 20, units = "cm")
